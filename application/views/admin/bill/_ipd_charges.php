...
?>
  <div class="box-tools pull-right box-miustop">
    ...
    <?php }
    if ($this->rbac->hasPrivilege('ipd_billing_payment', 'can_view')) { ?>
    ...
    <?php }
    if ($this->rbac->hasPrivilege('generate_bill', 'can_view')) { ?>
...
<div class="table-responsive">
  <table class="table table-striped table-bordered table-hover example">
    ...
    <tbody>
      ...
      ?>
          <tr>
            <td><?php if ($charges_value['date'] != '' && $charges_value['date'] != '0000-00-00') {
                  echo $this->customlib->YYYYMMDDHisTodateFormat($charges_value['date'], $this->customlib->getHospitalTimeFormat());
                } ?></td>
            <td class="">

            ...
            <table class="printablea4">
              ...
              <tr>
                ...
                <td class="text-right ipdbilltable">
                  ...
                  <input type="text" placeholder="Discount" name="discount_percent" id="discount_percent" onchange="addTotal()" class="form-control discount_percent" style="width: 70%; float: right;font-size: 12px;" />
                </td>

...
<div class="row">
  <div class="col-md-6">
    <p><strong> <?php echo $this->lang->line('test_name'); ?>: </strong> <?php echo $result->test_name; ?></p>
  </div>

  <div class="col-md-6">
    <p><strong> <?php echo $this->lang->line('sub_category'); ?>: </strong><?php echo $result->sub_category; ?></p>
  </div>
</div>
<div class="row">
  <div class="col-md-6">
    <p><strong> <?php echo $this->lang->line('category_name'); ?>: </strong><?php echo $result->lab_name; ?></p>
  </div>
  <div class="col-md-6">
    <p><strong> <?php echo $this->lang->line('charge_category'); ?>: </strong><?php echo $result->charge_category_name; ?></p>
  </div>
</div>
<div class="row">
  <div class="col-md-6">
    <p><strong> <?php echo $this->lang->line('charge_category'); ?>: </strong><?php echo $result->charge_name; ?></p>
  </div>
  <div class="col-md-6">
    <p><strong> <?php echo $this->lang->line('standard_charge'); ?>: </strong><?php echo $currency_symbol . $result->standard_charge; ?></p>
  </div>
</div>

          ...
          <table class="printablea4">
            <tr  style="display: none;">
              ...
              <td width="60%" colspan="2" class="text-right ipdbilltable">
                <input type="text" placeholder="Total" value="<?php echo $radiology_data->total; ?>" name="total" id="total" style="width: 30%; float: right" class="form-control total" />
              </td>
            </tr>
            <tr  style="display: none;">
              ...
              <td class="text-right ipdbilltable">
                ...
                <input type="text" placeholder="Discount" name="discount_percent" id="discount_percent" value="<?php echo $radiology_data->discount_percentage; ?>" onchange="addTotal()" class="form-control discount_percent" style="width: 70%; float: right;font-size: 12px;" />
              </td>
              <td class="text-right ipdbilltable">
                <input type="text" placeholder="Discount" value="<?php echo $radiology_data->discount; ?>" name="discount" id="discount" style="width: 50%; float: right" class="form-control discount" />
              </td>
            </tr>
            <tr  style="display: none;">
            ...
            <tr>
              ...
              <td colspan="2" class="text-right ipdbilltable">
                <input type="text" placeholder="Net Amount" value="<?php echo $radiology_data->net_amount; ?>" name="net_amount" id="net_amount" style="width: 30%; float: right" class="form-control net_amount" />
              </td>
            </tr>
          </table>
        </div>

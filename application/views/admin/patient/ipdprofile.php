              ...
              <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 border-r">
                  <div class="box-header border-b mb10 pl-0 pt0">
                    <h3 class="text-uppercase bolds mt0 ptt10 pull-left font14"><?php echo composePatientName($result['patient_name'], $result['patient_id']); ?>f</h3>
                    ...
                    foreach ($doctors_ipd as $dkey => $dvalue) { ?>
                      <div class="media">
                        ...
                        <div class="media-body">
                          ...
                          <h5 class="media-heading"><a href="<?php echo base_url(); ?>admin/staff/profile/<?php echo $dvalue['consult_doctor']; ?>"><?php echo  $dvalue['ipd_doctorname'] . " " . $dvalue['ipd_doctorsurname'] . " (" . $dvalue['employee_id'] . ")"; ?>admin/patient/ipdprofile</a>

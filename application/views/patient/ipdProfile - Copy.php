                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        ?>
                                                            ...
                                                            ?>
                                                                    <td class="dosehover">
                                                                        <?php echo $this->lang->line('time') . ": " . $this->customlib->YYYYMMDDHisTodateFormat($mvalue['dose_list'][$x]['time'], $this->customlib->getHospitalTimeFormat()) . "</a></br>" . $mvalue['dose_list'][$x]['medicine_dosage'] . " " . $mvalue['dose_list'][$x]['unit'];

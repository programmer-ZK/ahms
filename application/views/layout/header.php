        ...
        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-9">
          <div class="pull-right">
            ...
            <div class="navbar-custom-menu">
              ...
              ?>
                <!--ODN Comment <div class="langdiv"><select class="languageselectpicker" onchange="set_languages(this.value)"  type="text" id="languageSwitcher" >
                  ...
                  <li class="cal15">
                    ...
                    <a href="<?php echo base_url() . "admin/systemnotification" ?>">
                      ...
                      ?><span class="label label-warning">
                          <?php echo count($systemnotifications) ?>
                        </span>
                      <?php
                      }
                      ?>

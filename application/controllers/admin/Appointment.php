...
class Appointment extends Admin_Controller
{
  ...
  public function printShiftReport()
  {
    $print_details         = $this->printing_model->get('', 'opd_slip');
    $data["print_details"] = $print_details;
 ...
 */
  ...
  public function getDoctorFees()
  {
    ...
    echo json_encode(
      array(
        "fees"      => isset($charge_details->standard_charge) ? amountFormat($charge_details->standard_charge) : "",
